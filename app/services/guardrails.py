...
FALLBACK_GENERAL = "پیامتون رسید 🙏 لطفاً کمی دقیق‌تر توضیح بدید تا بهتر راهنمایی کنیم."
...
FALLBACK_LLM = (
    "سلام 👋 پیام شما دریافت شد. لطفاً نام یا عکس محصول/درخواست‌تون رو بفرستید تا دقیق راهنمایی کنیم."
)
